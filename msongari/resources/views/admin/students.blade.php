...
<div class="row">
   <div class="col-6">
      <h3>Boarders</h3>
      <ul>
   <!--echo each student in the database-->
   @foreach($boardingStudents as $boardingStudent)
   <li>{{$boardingStudent->name}}<span class="text-primary">({{ $boardingStudent->email }})</span></li>
   @endforeach
</ul>
   </div>
   ...
   <div class="col-6">
      ...
      <ul>
   <!--echo each student in the database-->
   @foreach($dayStudents as $dayStudent)
   <li>{{$dayStudent->name}}<span class="text-primary">({{ $dayStudent->email }})</span></li>
   @endforeach
</ul>
   </div>
        ...
        <option value="formOne">Form 1</option>
         <option value="formTwo">Form 2</option>
          <option value="formThree">Form 3</option>
           ...
           <option value="yearNine">Year 9</option>
           <option value="yearTen">Year 10</option>
           <option value="yearEleven">Year 11</option>
</select>
</div>
</div>
